...
export const metadata: Metadata = {
  title: "UGC Content Creation Agency | CreativeUGC",
  description: "Authentic user-generated content that drives real engagement. We create genuine UGC videos for brands that connects with audiences and converts.",
  keywords: "UGC content, user-generated content, content creation, social media marketing, TikTok content, Instagram Reels",
  metadataBase: new URL("https://creativeugc.com"),
  alternates: {
    canonical: "https://creativeugc.com"
  },
  openGraph: {
    title: "UGC Content Creation Agency | CreativeUGC",
    description: "Authentic user-generated content that drives real engagement and authentic brand connections.",
    siteName: "CreativeUGC",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764803609210-o6380e3i.jpg",
      alt: "UGC content production"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "UGC Content Creation Agency | CreativeUGC",
    description: "Authentic user-generated content that drives real engagement.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764803609210-o6380e3i.jpg"]
  },
  robots: {
    index: true,
    follow: true
